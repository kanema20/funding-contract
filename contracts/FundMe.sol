...
contract FundMe {
    ...
    function fund() public payable {
        //if (msg.value.getConversionRate(s_priceFeed) >= MINIMUM_USD) revert FundMe__NotOwner(); 
    ...
    function cheaperWithdraw() public payable onlyOwner {
        // read entire array into mem one time - instead of reading from storage every time
